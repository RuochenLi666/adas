...
CREATE TABLE `dangao_order` (
  ...
  `dianyuan_id` int(11) DEFAULT NULL COMMENT '派送员ID',
...
CREATE TABLE `yonghu` (
  ...
  `yonghu_sum_jifen` decimal(20,2) DEFAULT NULL COMMENT '总积分',
  `yonghu_new_jifen` decimal(20,2) DEFAULT NULL COMMENT '现积分',
...
/*Table structure for table `miandianshifu` */

DROP TABLE IF EXISTS `miandianshifu`;

CREATE TABLE `miandianshifu` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `username` varchar(200) DEFAULT NULL COMMENT '账户',
  `password` varchar(200) DEFAULT NULL COMMENT '密码',
  `miandianshifu_name` varchar(200) DEFAULT NULL COMMENT '面点师傅名称',
  `miandianshifu_phone` varchar(200) DEFAULT NULL COMMENT '联系方式',
  `miandianshifu_photo` varchar(200) DEFAULT NULL COMMENT '头像',
  `miandianshifu_delete` int(11) DEFAULT 1 COMMENT '逻辑删除 1正常 2删除',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='面点师傅';

/*Data for the table `miandianshifu` */

insert  into `miandianshifu`(`id`,`username`,`password`,`miandianshifu_name`,`miandianshifu_phone`,`miandianshifu_photo`,`miandianshifu_delete`,`create_time`) values
(1,'chef001','123456','测试师傅','13800138000','upload/yonghu1.jpg',1,'2023-04-07 17:31:32');


/*Table structure for table `miandianshifu_kucun` */

DROP TABLE IF EXISTS `miandianshifu_kucun`;

CREATE TABLE `miandianshifu_kucun` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `miandianshifu_id` int(11) DEFAULT NULL COMMENT '面点师傅',
  `dangao_id` int(11) DEFAULT NULL COMMENT '蛋糕',
  `bukucun_number` int(11) DEFAULT NULL COMMENT '补货数量',
  `bukucun_content` longtext COMMENT '补货备注',
  `miandianshifu_kucun_delete` int(11) DEFAULT 1 COMMENT '逻辑删除 1正常 2删除',
  `insert_time` timestamp NULL DEFAULT NULL COMMENT '补货时间',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='面点师傅补库存记录';
...
CREATE TABLE `warehouse` (
  ...
  `warehouse_capacity` int(11) DEFAULT NULL COMMENT '仓库容量',
  `warehouse_current_stock` int(11) DEFAULT 0 COMMENT '当前库存量',
  `warehouse_content` longtext COMMENT '仓库介绍',
  `warehouse_delete` int(11) DEFAULT 1 COMMENT '逻辑删除 1正常 2删除',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `delivery_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `dangao_order_id` int(11) DEFAULT NULL COMMENT '订单id',
  `dianyuan_id` int(11) DEFAULT NULL COMMENT '派送员id',
  `delivery_status` int(11) DEFAULT NULL COMMENT '派送状态 106待派送 107派送中 108已取消',
  `delivery_address` varchar(200) DEFAULT NULL COMMENT '派送地址',
  `delivery_notes` longtext COMMENT '派送备注',
  `delivery_delete` int(11) DEFAULT 1 COMMENT '逻辑删除 1正常 2删除',
  `insert_time` timestamp NULL DEFAULT NULL COMMENT '派送时间',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='派送记录';
...
CREATE TABLE `offline_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `offline_order_uuid_number` varchar(200) DEFAULT NULL COMMENT '订单号',
  `dangao_id` int(11) DEFAULT NULL COMMENT '商品',
  `customer_name` varchar(200) DEFAULT NULL COMMENT '客户名称',
  `customer_phone` varchar(200) DEFAULT NULL COMMENT '客户电话',
  `buy_number` int(11) DEFAULT NULL COMMENT '购买数量',
  `offline_order_true_price` decimal(10,2) DEFAULT NULL COMMENT '实付价格',
  `payment_status` int(11) DEFAULT NULL COMMENT '支付状态 101未支付 102已支付 103已取消',
  `offline_order_payment_types` int(11) DEFAULT NULL COMMENT '支付类型',
  `offline_order_remark` longtext COMMENT '备注',
  `offline_order_delete` int(11) DEFAULT 1 COMMENT '逻辑删除 1正常 2删除',
  `insert_time` timestamp NULL DEFAULT NULL COMMENT '订单创建时间',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
